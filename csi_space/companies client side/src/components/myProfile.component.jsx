                    ...
                    <div className="d-flex align-items-center justify-content-center">
                      <div class="w-75 text-muted pt-3 mt-2 d-flex flex-column p-3 statOne ">
                          <form class="form-signin whiteText animate__animated animate__fadeInRight">
                            ...
                            <label for="exampleFormControlFile1" className="pt-3"><h6 className="mouseMe"><i className="fa fa-file-pdf-o"></i> Upload CIPC document</h6></label> <span class="badge badge-pill badge-info">No file</span>
